...
@SourceType(value = "Office365ARP", label = "Office365",uiConfig = "office365-layout.json")
public class Office365Conf extends AbstractArpConf<Office365Conf> {
  private static final String ARP_FILENAME = "arp/implementation/office365-arp.yaml";
  private static final ArpDialect ARP_DIALECT =
      AbstractArpConf.loadArpFile(ARP_FILENAME, (ArpDialect::new));
  private static final String DRIVER = "cdata.jdbc.office365.Office365Driver";
